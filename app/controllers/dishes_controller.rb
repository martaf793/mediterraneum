        ...
        "messages" => [
          {
            "role"    => "system",
            "content" =>
              "You are an expert nutritionist. For each meal, identify how many ingredients belong to each of these food groups: vegetables(Lettuce, Cabbage, Broccoli, Cauliflower, Carrot, Beetroot, sweet potato, Potato, eggplant, zucchini, cucumber, Pumpkin, Onion), legumes (beans, lentils, chickpeas), fish, eggs, white meat (chicken, turkey), red meat (beef, lamb, pork, pepperoni), whole grains (brown rice, quinoa, oats, pasta, pizza). Return your count for each. In notes, tell all the examples of each food group the dish has and some nutritionist information of the dish." \
